...
require(['jquery', 'core/modal_factory', 'core/modal_events', 'core/ajax', 'core/notification'], function($, ModalFactory, ModalEvents, Ajax, Notification) {
    var trigger = $('.local_sponsor_delete_button');
    ModalFactory.create({
       type: ModalFactory.types.SAVE_CANCEL,
       title: 'Delete Sponsor',
       body: '<p>Are you sure to delete this sponsor ?</p>',
       preShowCallback: function(triggerElement, modal) {
          ...
          modal.params = {'id': id};
          modal.setSaveButtonText('Delete Sponsor');
       },
       large: true
    }, trigger)
    .done(function(modal) {
       ...
       modal.getRoot().on(ModalEvents.save, function(e) {
          ...
          spinner.show();
          let request = {
                methodname: 'local_sponsor_delete_sponsor',
                args: modal.params,
          };
