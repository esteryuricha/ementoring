...
require(['jquery', 'core/modal_factory', 'core/modal_events', 'core/ajax', 'core/notification'], function($, ModalFactory, ModalEvents, Ajax, Notification) {
    var trigger = $('.local_manager_delete_button');
    ModalFactory.create({
       type: ModalFactory.types.SAVE_CANCEL,
       title: 'Delete Manager',
       body: '<p>Are you sure to delete this manager ?</p>',
       preShowCallback: function(triggerElement, modal) {
          ...
          modal.params = {'id': id};
          modal.setSaveButtonText('Delete Manager');
       },
       large: true
    }, trigger)
    .done(function(modal) {
       ...
       modal.getRoot().on(ModalEvents.save, function(e) {
          ...
          spinner.show();
          let request = {
                methodname: 'local_manager_delete_manager',
                args: modal.params,
          };
